...
public class DestinationsPage {
  ...
  public void getrouteMap() {
    new Actions(webdriver).moveToElement(webdriver.findElement(By.cssSelector(".destinations a")))
        .build().perform();
    WebDriverWait wait = new WebDriverWait(webdriver, 5);
    wait.until(ExpectedConditions
        .visibilityOfElementLocated(By.partialLinkText("City Guides & Walking Tours")));
    webdriver.findElement(By.linkText("City Guides & Walking Tours")).click();
    // WebElement routebtn = webdriver.findElement(By.cssSelector("ul.nav_links li.destinations
    // li.nav_sublinks li.collinks4 a.button
    // a[href='https://www.amtrak.com/city-guides-dining-attractions-maps']"));
    // WebElement routebtn = webdriver.findElement(By.cssSelector("div#nav_layer div#nav_sec
